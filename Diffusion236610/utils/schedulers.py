# Taken from https://github.com/rosinality/vq-vae-2-pytorch and lightly modified

from math import cos, pi, floor, sin
from torch.optim import lr_scheduler


# TODO: Adapt the schedulers API tp the project expected API
...
class PowerLR(lr_scheduler._LRScheduler):
    ...
    def get_lr(self):
        if self.iteration < self.warmup:
            lr = self.lr_min + ((self.lr_max - self.lr_min) / (self.warmup * self.iteration))
